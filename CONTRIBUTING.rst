...
Welcome to ``sales_forecast`` contributor's guide.
...
If you experience bugs or general issues with ``sales_forecast``, please have a look
...
You can help improve ``sales_forecast`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sales_forecast`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sales_forecast``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n sales_forecast python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sales_forecast.git
    cd sales_forecast
...
#. Install |pre-commit|_::
   ...
   ``sales_forecast`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sales_forecast
.. _issue tracker: https://github.com/<USERNAME>/sales_forecast/issues
.. <-- end -->
